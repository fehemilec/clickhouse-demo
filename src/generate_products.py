...
end_date = datetime(2023, 12, 30)  # End date of the time series

# Generate random user_ids and meter_ids
user_ids = [f"{i}" for i in range(100, 500)]  # Example user IDs (user_1 to user_1000)
meter_ids = [f"{i}" for i in range(100, 500)]  # Example meter IDs (meter_1 to meter_1000)
